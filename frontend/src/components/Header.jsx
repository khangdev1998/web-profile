...
const Header = () => {
  return (
    <div className="border-gray-200 dark:border-gray-600 dark:bg-gray-800 fixed top-0 left-0 w-full z-50 shadow-xl">
      <div className="container flex flex-wrap justify-between items-center">
        ...
        >
          <img
            ...
            alt="Flowbite Logo"
          />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white -tracking-tighter">
            KhangDev
          </span>
        </Link>
        <button
          ...
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
            ...
            <li>
              <button
                ...
                className="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-900 border-b border-gray-100 md:w-auto md:hover:bg-transparent md:border-0 md:p-0 dark:text-white focus:outline-none bg-transparent hover:text-blue-500"
              >
                Company{" "}
                <svg
