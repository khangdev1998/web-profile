...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dynamic_zone: Schema.Attribute.DynamicZone<
      ['shared.media', 'shared.quote', 'shared.slider']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    as: Schema.Attribute.BigInteger &
    ...
    profile: Schema.Attribute.Component<'shared.profile', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    testz: Schema.Attribute.Enumeration<['a', 'b', 'c', 'd', 'test']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    menu_itemzs: Schema.Attribute.Relation<
      'oneToMany',
      'api::menu-itemz.menu-itemz'
    >;
    path: Schema.Attribute.UID<'title'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMenuItemzMenuItemz extends Struct.CollectionTypeSchema {
  collectionName: 'menu_itemzs';
  info: {
    description: '';
    displayName: 'MenuItemz';
    pluralName: 'menu-itemzs';
    singularName: 'menu-itemz';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    technology: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::menu-itemz.menu-itemz': ApiMenuItemzMenuItemz;
